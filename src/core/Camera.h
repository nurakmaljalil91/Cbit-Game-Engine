...
public:
    ...
    virtual void Rotate(float cam_yaw, float cam_pitch) {} // in degrees
...
public:
    FPSCamera(glm::vec3 fps_cam_pos = glm::vec3(0.0f, 0.0f, 0.0f), float fps_cam_yaw = glm::pi<float>(), float fps_cam_pitch = 0.0f);
